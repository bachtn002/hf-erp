odoo.define('ev_promotion_voucher_custom.ButtonPromotionVoucher', function (require) {
    "use strict"
    const ButtonPromotionVoucher = require('ev_promotion_voucher.ButtonPromotionVoucher');
    const Registries = require('point_of_sale.Registries');

    const CustomButtonPromotionVoucher = ButtonPromotionVoucher => class extends ButtonPromotionVoucher {
    ...
    Registries.Component.extend(ButtonPromotionVoucher, CustomButtonPromotionVoucher);
