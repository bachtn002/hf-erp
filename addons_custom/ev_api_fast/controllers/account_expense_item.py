...
class AccountExpenseItem(http.Controller):

    @http.route('/account_expense_item', methods=['POST'], type='json', auth='public')
    def get_account_expense_item(self):
        ...
        if not is_ip_valid:
            ...
            Configs._set_log_api(remote_ip, '/account_expense_item', '', params, '400', mesg)
        ...
        if not api_id:
            ...
            Configs._set_log_api(remote_ip, '/account_expense_item', '', params, '401', mesg)
