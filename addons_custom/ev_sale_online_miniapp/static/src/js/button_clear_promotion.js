odoo.define('ev_sale_online_miniapp.PromotionVoucherProductScreen', function (require) {
    'use strict'

    const PromotionVoucherProductScreen = require('ev_promotion_voucher.PromotionVoucherProductScreen')
    const Registries = require('point_of_sale.Registries')

    let ButtonClearPromotion = PromotionVoucherProductScreen => class extends PromotionVoucherProductScreen {
        handleOnClickClearPromotionButton(ev) {
            ...
            return this.env.pos.get_order().sale_online ? (() => {
                if (this.env.pos.get_order().is_created_by_api) {
                    ...
                    super.handleOnClickClearPromotionButton(ev)
                }
            })() : super.handleOnClickClearPromotionButton(ev)
    ...
    Registries.Component.extend(PromotionVoucherProductScreen, ButtonClearPromotion)
    return PromotionVoucherProductScreen
})