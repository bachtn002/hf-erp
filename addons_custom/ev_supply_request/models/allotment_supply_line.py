...
class AllotmentSupplyLine(models.Model):
    _name = 'allotment.supply.line'
    _description = 'Allotment Supply Detail'

    allotment_supply_id = fields.Many2one('allotment.supply', string='Allotment Supply', ondelete='cascade')
