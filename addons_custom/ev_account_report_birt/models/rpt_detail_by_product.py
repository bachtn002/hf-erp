...
class RPTDetailByProduct(models.TransientModel):
    _name = 'rpt.detail.by.product'
    ...
    def _get_param(self):
        ...
        param_str = {
            ...
            '&contra_account_id': self.account_id.code
        }
        report_name = "Bang_ke_chi_tiet_theo_san_pham.rptdesign"
    ...
    def action_export_report(self):
        ...
        return {
            ...
            'name': 'RPT Account Journal General',
