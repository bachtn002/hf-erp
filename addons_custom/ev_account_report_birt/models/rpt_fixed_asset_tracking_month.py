...
class RPTFixedAssetTrackingMonth(models.TransientModel):
    _name = 'rpt.fixed.asset.tracking.month'
    ...
    def _get_param(self):
        ...
        report_name = "rpt_fixed_asset_tracking_month.rptdesign"
