...
class RPTALLInOutMove(models.TransientModel):
    _name = 'rpt.all.in.out.move'
    ...
    def _get_param(self):
        ...
        report_name = ''
        if self.type == 'in':
            report_name = "tong_hop_nhap_theo_but_toan.rptdesign"
        else:
            report_name = "tong_hop_xuat_theo_but_toan.rptdesign"
