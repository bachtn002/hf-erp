...
class RPTSpreadsheetDepreciation(models.TransientModel):
    _name = 'rpt.spreadsheet.depreciation'
    ...
    def _get_param(self):
        ...
        report_name = "rpt_spreadsheet_depreciation.rptdesign"
