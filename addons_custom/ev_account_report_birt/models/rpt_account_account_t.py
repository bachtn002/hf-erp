...
class RptAccountAccountT(models.TransientModel):
    _name = 'report.account.account.t'
    ...
    def _get_param(self):
        ...
        report_name = "So_tong_hop_chu_t_mot_tai_khoan.rptdesign"
