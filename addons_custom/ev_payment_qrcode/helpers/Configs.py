...
def get_request_ip(request):
    try:
        ip_public = None
        ip_public = request.httprequest.headers.environ['REMOTE_ADDR']
        ...
        _logger.error('Check private IP Exception: %s', ex)
        return None
