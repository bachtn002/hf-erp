...
class SpreadsheetDepreciationStore(models.Model):
    _name = 'spreadsheet.depreciation.store'
    _description = 'Spreadsheet Depreciation Store'
    _auto = False
    ...
    def _get_data_query(self, **kwargs):
        ...
        try:
            ...
            sql = """
                select tents, mats, CAST(ngaytinhkh as varchar), sokyhk, case
                ...
                from (
                    ...
                    (select sum(am.amount_total)
                        ...
                        where aa.id = b.id
                        and am.state = 'posted'
                        and to_date(to_char(am.date + INTERVAL '7 hours', 'dd/mm/yyyy'), 'dd/mm/yyyy') <= to_date(%s, 'dd/mm/yyyy')) as gtdakh,
