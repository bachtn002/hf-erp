odoo.define('stock.WarehouseInventoryValidationController', function (require) {
"use strict";
...
var InventoryValidationController = ListController.extend({
    ...
    renderButtons: function () {
        ...
        var $validationButton = $(qweb.render('WarehouseInventoryLines.Buttons'));
    ...
    _onValidateInventory: function () {
        ...
        prom.then(function () {
            self._rpc({
                ...
                method: 'warehouse_confirm_check',
